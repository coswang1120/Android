...
#####執行結果:
![GitHub Logo](/images/results04-4.jpg)
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        blur(imageView, R.drawable.icon400, 0.3, 12.5); //傳入顯示物件, 圖片Id, 模糊程度, 顆粒大小
    }


    //---------------------------------------------------------------------------
    // 將傳入圖片模糊化, 模糊程度(bitmap_scale), 模糊顆粒大小(bitmap_radius)
    //---------------------------------------------------------------------------
    public void blur(ImageView imageView, int imageId, double bitmap_scale, double bitmap_radius) {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), imageId);

        int width = (int)(Math.round(bitmap.getWidth() * bitmap_scale));
        int height = (int)(Math.round(bitmap.getHeight() * bitmap_scale));
        ...
        theIntrinsic.setRadius((float)bitmap_radius);
