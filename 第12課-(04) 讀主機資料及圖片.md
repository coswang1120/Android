...
#####執行結果: 
![GitHub Logo](/images/results12-4.jpg)
...
<resources>
    ...
    <color name="colorAccent">#801515</color>

    <color name="cardBack">#550000</color>
...
public class Common{
    ...
    // 設定最大顯示文字字數
    //--------------------------
    public static int maxTextLength=85;
}
```
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.DataViewHolder>{
    ...
    //----------------------------
    @Override
    public void onBindViewHolder(DataViewHolder dataViewHolder, int index) {
        Book book=(Book)books.get(index);
        dataViewHolder.titleText.setText(book.getTitle());
        dataViewHolder.descText.setText(book.getDesc());
        dataViewHolder.bookImg.setImageBitmap(books.get(index).img);

        dataViewHolder.position=index;
    }
