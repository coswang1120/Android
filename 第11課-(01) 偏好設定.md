...
<resources>
    ...
    <string name="pref_title_display_name">顯示姓名</string>
...
<preference-headers xmlns:android="http://schemas.android.com/apk/res/android">
    ...
    <header
        android:fragment="com.abc.myapplication.SettingsActivity$GeneralPreferenceFragment"
        android:icon="@drawable/ic_info_black_24dp"
        android:title="@string/pref_header_general" />

    <header
        android:fragment="com.abc.myapplication.SettingsActivity$NotificationPreferenceFragment"
        android:icon="@drawable/ic_notifications_black_24dp"
        android:title="@string/pref_header_notifications" />

    <header
        android:fragment="com.abc.myapplication.SettingsActivity$DataSyncPreferenceFragment"
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 顯示偏好值
                //----------------
                String info="顯示姓名:" + getPreferenceName();
    ...
    //------------------------------------------------
    // 當 MainActivity 首次執行及由其他Activity返回時
    //------------------------------------------------
    @Override
