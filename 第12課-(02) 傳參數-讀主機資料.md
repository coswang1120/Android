...
#####執行結果: 
![GitHub Logo](/images/results12-2.jpg)
...
#####資料讀取測試
```
http://105stu.ntub.edu.tw/data_02?segId=1
http://105stu.ntub.edu.tw/data_02?segId=2
http://105stu.ntub.edu.tw/data_02?segId=3
   .
   .
   .
```
...
+=======================================+
|                                       |
|   http://105stu.ntub.edu.tw/data_02   |
|                                       |
+=======================================+
...
public class Common{
    ...
    //(2) 若連結現有測試主機
    //--------------------------
    public static String url="http://105stu.ntub.edu.tw/data_02";
}
```
...
public class MyAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            // 第2個參數是區段編號
            //=======================
            String args = "segId=" + URLEncoder.encode(params[1], "UTF-8");
            writer.write(args);
            writer.flush();
            writer.close();
            os.close();
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void getAndDisplayData() {
        ...
        // (2)取得輸入之區段編號
        //=====================
        TextView segIdText=(TextView)findViewById(R.id.segId);
